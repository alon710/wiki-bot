    ...
    def create_template(self, template_name: str, template_data: dict):
        ...
        try:
            ...
            content = self.client.content.v1.contents.create(
                ...
                types={
                    "twilio/text": {
                        "body": template_data["components"][0]["text"]
                    }
                }
            )
            ...
            logger.error("Failed to create template", template_name=template_name, error=str(e))
    ...
    def create_all_templates(self):
        ...
        if created_templates:
            ...
            for template_name, sid in created_templates.items():
                env_var = mapping.get(template_name, f"TWILIO_{template_name.upper()}_SID")
                print(f"{env_var}={sid}")
    ...
    def show_template_examples(self):
        ...
        for name, template_data in templates.items():
            ...
            if 'example' in template_data['components'][0]:
                print(f"   Variables: {template_data['components'][0]['example']['body_text']}")
